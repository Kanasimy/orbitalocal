...
<tfoot><tr><td colspan="2"><input type="submit" class="btn-primary btn" name="autorize" value="<?echo GetMessage("adm_auth_butt")?>" /></td></tr></tfoot>
</table>
...
<tfoot><tr><td colspan="2"><input class="btn btn-primary" type="submit" name="sendpassword" value="<?echo GetMessage("subscr_pass_button")?>" /></td></tr></tfoot>
</table>
