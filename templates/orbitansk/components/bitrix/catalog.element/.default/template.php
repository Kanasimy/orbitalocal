...
<div id="<?=$itemIds['ID']?>"
	 itemscope itemtype="http://schema.org/Product" xmlns="http://www.w3.org/1999/html">
		...
		?>
		<div class="row">
			<div class="col-md-5 col-sm-6" id="<?=$itemIds['BIG_SLIDER_ID']?>">
						<?
						...
						?>
						<div class="product-images" data-entity="images-container">
							<?
							if (!empty($actualItem['MORE_PHOTO']))
							{
								...
								{
									?>
									<div data-entity="images-container" class="images-gallery<?=($key == 0 ? ' active' : '')?>" data-entity="image" data-id="<?=$photo['ID']?>">
										<img id="images-gallery_big" class="images-gallery_big" src="<?=$photo['SRC']?>" alt="<?=$alt?>" title="<?=$title?>"<?=($key == 0 ? ' itemprop="image"' : '')?>>
									</div>
									<?
								}
							}
				...
				<?  if (!empty($arResult['DISPLAY_PROPERTIES']['CML2_TRAITS']) || $arResult['SHOW_OFFERS_PROPS']){?>
					<div class="product-in-box">
								...
								<div class="product-in-box__value">
									<?=$arResult['DISPLAY_PROPERTIES']['CML2_TRAITS']['VALUE'][4]?> øò.
								</div>
							</div>
					<div class="product-min">
							ìèí. êîë-âî
							<div class="product-min__value">
								<?=$arResult['DISPLAY_PROPERTIES']['CML2_TRAITS']['VALUE'][3]?> øò.
							</div>
						</div>
				<?}?>
								...
								<? if ($arParams['USE_PRODUCT_QUANTITY'])
											{
												?>
												<div class="col-sm-6">
													<div class="catalog-item__count" style="<?=(!$actualItem['CAN_BUY'] ? 'display: none;' : '')?>"
													 data-entity="quantity-block">
														...
														<div class="product-item-amount-field-container input-group">
															<span class="input-group-btn"><a class="catalog-item__count_btn product-item-amount-field-btn-minus" id="<?=$itemIds['QUANTITY_DOWN_ID']?>"
																							 href="javascript:void(0)" rel="nofollow">
															</a></span>
															<input class="form-control" id="<?=$itemIds['QUANTITY_ID']?>" type="tel"
																   value="<?=$price['MIN_QUANTITY']?>">
															<span class="input-group-btn"><a class="catalog-item__count_btn product-item-amount-field-btn-plus" id="<?=$itemIds['QUANTITY_UP_ID']?>"
																							 href="javascript:void(0)" rel="nofollow">
															</a></span>
														...
														<div><span class="product-item-amount-description-container">
													...
													<? if($arResult['PROPERTIES']['TORGOVAYA_MARKA']['VALUE']&&$arResult['PROPERTIES']['TORGOVAYA_MARKA']['VALUE']!="_ÒÎÐÃÎÂÀß ÌÀÐÊÀ ÎÒÑÓÒÑÒÂÓÅÒ"){?>
												...
												<div class="col-sm-6">
													<div class="product-buy__price">
														<div class="product-buy__price_text">Öåíà:</div>
														<?
														if ($arParams['SHOW_OLD_PRICE'] === 'Y')
														{
															?>
															<div class="product-buy__price_old" id="<?=$itemIds['OLD_PRICE_ID']?>"
														...
														?>
														<div class="product-buy__price_new" id="<?=$itemIds['PRICE_ID']?>">
														...
														<div id="<?=$itemIds['BASKET_ACTIONS_ID']?>" style="display: <?=($actualItem['CAN_BUY'] ? '' : 'none')?>;">
															...
															if ($showAddBtn)
															{
																...
																<div class="product-buy__btn">
																	<a class="btn btn-default btn-sm <?=$showButtonClassName?>" id="<?=$itemIds['ADD_BASKET_LINK']?>"
															...
															if ($showBuyBtn)
															{
																?>
                                                                <div class="product-buy__btn">
                                                                    <button type="button" class="btn btn-default btn-sm" id="<?=$itemIds['BUY_LINK']?>"
                                                                            href="javascript:void(0);">
