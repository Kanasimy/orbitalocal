                    ...
                    <div class="product-item-detail-slider-container" id="<?=$itemIds['BIG_SLIDER_ID']?>">
						...
						<?=($arParams['IMAGE_RESOLUTION'] === '1by1' ? 'product-item-detail-slider-block-square' : '')?>"
                            ...
                            <div class="product-item-detail-slider-images-container" data-entity="images-container">
                                ...
                                {
                                    if (count($actualItem["VIDEO"]) > 0) :
                                        foreach ($actualItem["VIDEO"] as $key => $val) :?>
                                            <div class="product-item-detail-slider-image<?=($key == 0 ? ' active' : '')?>" data-entity="image" data-id="<?=$actualItem["MORE_PHOTO"][$key]['ID']?>">
                                                <video width="100%" height="100%" controls poster="<?=$actualItem["MORE_PHOTO"][$key]["SRC"]?>" preload="none">
                                    ...
                                    {
                                        if($key >= count($actualItem["VIDEO"] && count($actualItem["VIDEO"]) > 0) || count($actualItem["VIDEO"]) === 0) :
                                        ?>
                                    ...
                                    <div class="product-item-detail-slider-image active" data-entity="image">
                                        <img src="<?=$actualItem[DETAIL_PICTURE]['SRC']?>" alt="<?=$alt?>" title="<?=$title?>" itemprop="image">
                                    </div>
                                    <?
                                }
                            ...
                            else
                            {
                                ...
                                <div class="product-item-detail-slider-controls-block" id="<?=$itemIds['SLIDER_CONT_ID']?>">
                                    <?if (count($arResult["VIDEO"]) > 0) :?>
                                        ...
                                        <?foreach ($actualItem["VIDEO"] as $key => $val):?>
                                            <div class=" video-preview product-item-detail-slider-controls-image<?=($key == 0 ? ' active' : '')?>"
                                                 data-entity="slider-control" data-value="<?=$actualItem["MORE_PHOTO"][$key]['ID']?>">
                                                <img src="<?=$actualItem["MORE_PHOTO"][$key]['SRC']?>">
                                            </div>
                                        <?endforeach;?>
