...
<h2 class="red">ѕќѕ”Ћя–Ќџ≈ “ќ¬ј–џ</h2>
<div class="row popular">
    <div class="owl-carousel owl-carousel-popular">
<!--FIXME-->
    <!--”брать количество товаров в строку, не используетс€, TD_WIDTH, LINE_ELEMENT_COUNT-->
	<?foreach($arResult["ROWS"] as $arItems):?>
		...
		?>
			<a href="<?=$arElement["DETAIL_PAGE_URL"]?>" class="popular__item" id="<?=$this->GetEditAreaId($arElement['ID']);?>">
                <div class="popular__icon popular__icon-red">
                    <svg class="icons icon-hot popular__icon-hot">
                        <use xlink:href="<?= SITE_TEMPLATE_PATH ?>/images/sprite.svg#hot"></use>
                    </svg>
                </div>
