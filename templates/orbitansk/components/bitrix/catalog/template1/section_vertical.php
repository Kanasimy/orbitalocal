...
if ($isFilter || $isSidebar): ?>
	<div class="col-md-3 col-md-push-9<?=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' hidden-xs' : '')?>">
		<? if ($isFilter): ?>
			<div class="bx-sidebar-block sidebar">
				<?
...
<?endif?>
<!-- v -->
<div class="<?=(($isFilter || $isSidebar) ? "col-md-9 col-md-pull-3" : "col-xs-12")?>">
	<div class="row">
		<div class="col-xs-12">
			<?
